  ...
  return (
    <div>
      {user ? (
        ...
        <div className="flex flex-col gap-4 border-4 border-yellow-300 bg-yellow-50 rounded-2xl p-6 w-80 shadow-2xl">
          <input
            id="name"
            name="name"
            value={username}
          ...
          <Link
            href="/loggin"
            className="bg-yellow-400 hover:bg-yellow-500 mt-4 px-4 py-2 rounded text-white font-bold text-center flex gap-2 justify-center"
          >
            <p>Zum loggin</p>
            <div>
              <svg
